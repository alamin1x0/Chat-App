...
public class Specifchart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specifchart);
        ...
        messagesAdapter=new MessagesAdapter(Specifchart.this,messagesArrayList);
